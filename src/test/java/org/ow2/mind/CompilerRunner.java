...
public class CompilerRunner {
	...
	public CompilerRunner(final Map<Object, Object> initialContext)
		...
		// SSZ: Addition to the original tests setup: We need to tell the tests to use the "--simple-gen" option
		...
		try {
			final CommandLine cmdLine = CommandLine.parseArgs(options, false, "--simple-gen");
